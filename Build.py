...
def doBuild_Win32():
	commandline_Debug = 'msbuild ./Rockcat.sln -t:rebuild /p:Configuration=Debug'
	commandline_Release = 'msbuild ./Rockcat.sln -t:rebuild /p:Configuration=Release'
