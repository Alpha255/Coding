...
inline Vec##Dimension lerp(const Vec##Dimension &left, const Vec##Dimension& right, float32_t factor)                                                         \
{                                                                                                                                                             \
	Vec##Dimension Result;                                                                                                                                    \
	VECTOR_STORE(Dimension, &Result, DirectX::XMVectorLerp(VECTOR_LOAD(Dimension, &left), VECTOR_LOAD(Dimension, &right), factor));                           \
	return Result;                                                                                                                                            \
}                                                                                                                                                             \
inline Vec##Dimension lerpV(const Vec##Dimension & left, const Vec##Dimension & right, const Vec##Dimension& factor)                                          \
{                                                                                                                                                             \
	Vec##Dimension Result;                                                                                                                                    \
