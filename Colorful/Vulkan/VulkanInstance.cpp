...
VulkanDebugUtilsMessenger::VulkanDebugUtilsMessenger(bool8_t verbose)
{
	PFN_vkCreateDebugUtilsMessengerEXT vkCreateDebugUtilsMesserger = reinterpret_cast<PFN_vkCreateDebugUtilsMessengerEXT>(
		vkGetInstanceProcAddr(s_Device->instance(), "vkCreateDebugUtilsMessengerEXT"));
	...
	VERIFY_VK(vkCreateDebugUtilsMesserger(s_Device->instance(), &createInfo, VK_MEMORY_ALLOCATOR, reference()));
}
...
VulkanDebugUtilsMessenger::~VulkanDebugUtilsMessenger()
{
	PFN_vkDestroyDebugUtilsMessengerEXT vkDestroyDebugUtilsMessenger = reinterpret_cast<PFN_vkDestroyDebugUtilsMessengerEXT>(
		vkGetInstanceProcAddr(s_Device->instance(), "vkDestroyDebugUtilsMessengerEXT"));
	assert(vkDestroyDebugUtilsMessenger);
	vkDestroyDebugUtilsMessenger(s_Device->instance(), get(), VK_MEMORY_ALLOCATOR);
}
